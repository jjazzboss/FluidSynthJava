...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fluidsynth_h.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        fluidsynth_h.C_POINTER.withName("_IO_read_ptr"),
        fluidsynth_h.C_POINTER.withName("_IO_read_end"),
        fluidsynth_h.C_POINTER.withName("_IO_read_base"),
        fluidsynth_h.C_POINTER.withName("_IO_write_base"),
        fluidsynth_h.C_POINTER.withName("_IO_write_ptr"),
        fluidsynth_h.C_POINTER.withName("_IO_write_end"),
        fluidsynth_h.C_POINTER.withName("_IO_buf_base"),
        fluidsynth_h.C_POINTER.withName("_IO_buf_end"),
        fluidsynth_h.C_POINTER.withName("_IO_save_base"),
        fluidsynth_h.C_POINTER.withName("_IO_backup_base"),
        fluidsynth_h.C_POINTER.withName("_IO_save_end"),
        fluidsynth_h.C_POINTER.withName("_markers"),
        fluidsynth_h.C_POINTER.withName("_chain"),
        fluidsynth_h.C_INT.withName("_fileno"),
        fluidsynth_h.C_INT.withName("_flags2"),
        fluidsynth_h.C_LONG.withName("_old_offset"),
        fluidsynth_h.C_SHORT.withName("_cur_column"),
        fluidsynth_h.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, fluidsynth_h.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        fluidsynth_h.C_POINTER.withName("_lock"),
        fluidsynth_h.C_LONG.withName("_offset"),
        fluidsynth_h.C_POINTER.withName("_codecvt"),
        fluidsynth_h.C_POINTER.withName("_wide_data"),
        fluidsynth_h.C_POINTER.withName("_freeres_list"),
        fluidsynth_h.C_POINTER.withName("_freeres_buf"),
        fluidsynth_h.C_LONG.withName("__pad5"),
        fluidsynth_h.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, fluidsynth_h.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
